...
LOCAL_NXF_PIPELINE="$SCRIPTS_DIR/src/proteinfold-1.1.1"
...
if [[ -n "$params_file" ]]; then
    NXF_COMMAND="$NXF_COMMAND -params-file $params_file"
fi
...
pipe_log_success "Finished $NXF_PIPELINE_TASK" "$NXF_PIPELINE_TASK"
