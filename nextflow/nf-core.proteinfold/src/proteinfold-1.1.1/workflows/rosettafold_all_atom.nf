...
//
include { PREPARE_ROSETTAFOLD_ALL_ATOM_DB_WORKDIR } from '../modules/local/prepare_rosettafold_all_atom_db_workdir'
...
workflow ROSETTAFOLD_ALL_ATOM {
    ...
    rosettafold_all_atom_db_workdir = PREPARE_ROSETTAFOLD_ALL_ATOM_DB_WORKDIR(
        params.rosettafold_all_atom_db_workdir,
        ch_bfd,
        ch_uniref30,
        ch_pdb100,
    ...
    ch_samplesheet_rosettafold_all_atom = ch_samplesheet
        .map { [it[0]+[model: 'rosettafold_all_atom'], it[1]] }

    RUN_ROSETTAFOLD_ALL_ATOM (
        ch_samplesheet_rosettafold_all_atom,
        rosettafold_all_atom_db_workdir
    )
