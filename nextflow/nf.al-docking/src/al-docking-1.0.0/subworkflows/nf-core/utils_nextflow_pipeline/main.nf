...
workflow UTILS_NEXTFLOW_PIPELINE {
    ...
    //
    def params_json_fn = dumpParametersToJSON(outdir)
    def res_params_json = Channel.fromPath(params_json_fn)
...
// Dump pipeline parameters to a JSON file
//
def String dumpParametersToJSON(outdir) {
    ...
    def out_fn = "${outdir}/pipeline_info/params_${timestamp}.json"
    nextflow.extension.FilesEx.copyTo(temp_pf.toPath(), out_fn)
    temp_pf.delete()
