...
def get_atom_feature(atom: Chem.rdchem.Atom) -> list:  # making one hot encoding about the data
	...
	atom_feature += one_of_k_encoding(atom.GetValence(Chem.IMPLICIT), [0, 1, 2, 3, 4, 5])#number of implicit Hs on the atom
